...
* [FEATURE] Distributor: Add experimental `memberlist` KV store for ha_tracker. It can be enabled using the `-distributor.ha-tracker.kvstore.store` flag. Memberlist parameters can be configured via the `-memberlist-*` flags. #10054
